  ...
  return (
    <section className="py-24 bg-background" id="faq">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-serif text-foreground mb-4">What do athletic directors ask about Recovery Pods?</h2>
          <p className="text-muted-foreground text-lg">Everything you need to know about BH Labs Recovery Pods for university athletics.</p>
        </motion.div>
