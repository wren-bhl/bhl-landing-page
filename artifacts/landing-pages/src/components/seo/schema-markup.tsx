  ...
  useEffect(() => {
    ...
    const product = {
      ...
      "description": page === "hotels"
        ? "Turnkey wellness pod for hotels featuring HBOT, red light therapy, infrared sauna, lymphatic drainage suits, and PEMF devices. Generates $27K+/month in new revenue."
    ...
    const faqs = page === "hotels" ? [
      ...
      { q: "What equipment is included in a Recovery Pod?", a: "Each Recovery Pod includes an HBOT (Hyperbaric Oxygen Therapy) chamber, red light therapy panels, an infrared sauna, lymphatic drainage suits, and PEMF (Pulsed Electromagnetic Field) devices." },
      ...
      { q: "How do wellness tourists spend compared to average travelers?", a: "According to the Global Wellness Institute, wellness tourists spend 41-175% more than average travelers, making a Recovery Pod a powerful driver of higher-value bookings." }
    ] : [
      ...
      { q: "What equipment is included?", a: "Each Recovery Pod includes an HBOT chamber, red light therapy panels, infrared sauna, lymphatic drainage suits, PEMF devices, and custom architectural design." },
    ...
    [localBusiness, product, faqSchema].forEach(schema => {
    ...
    if (page === "hotels") {
      document.title = "BH Labs | Turnkey Recovery Pods for Hotels & Resorts — $324K Annual Revenue";
      ...
      setMeta("property", "og:title", "BH Labs | Turnkey Recovery Pods for Hotels & Resorts");
      ...
      document.title = "BH Labs | Recovery Pods for Luxury Residential & HOAs — 10-25% Property Value Increase";
      document.querySelector('meta[name="description"]')?.setAttribute("content",
      ...
      setMeta("property", "og:title", "BH Labs | Recovery Pods for Luxury Residential & HOAs");
